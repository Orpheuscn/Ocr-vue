...
const translations = {
  zh: {
    ...
    copy: '保存',
    copied: '已保存',
    copyOriginalText: '保存原始文本',
    copyFilteredText: '保存过滤后文本',
    copyMarkdownTable: '保存Markdown表格',
    or: '或',
    pressCtrlV: '按',
    clear: '清除',
    table: '表格',
  ...
  en: {
    ...
    copy: 'Save',
    copied: 'Saved',
    copyOriginalText: 'Save original text',
    copyFilteredText: 'Save filtered text',
    copyMarkdownTable: 'Save Markdown Table',
    or: 'or',
    pressCtrlV: 'press',
    clear: 'Clear',
    table: 'Table',
    ...
    zoom: 'Zoom',
    textCopied: 'Text saved',
    copyFailed: 'Save failed, please try again',
